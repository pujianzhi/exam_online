    ...
    <form class="form form-horizontal" id="form-article-add">
        <div class="row cl" hidden>
            ...
            <div class="formControls col-xs-8 col-sm-9">
                <input type="text" class="input-text" value="${question1.smd_questions.state}" placeholder="" id="state" name="state">
            </div>
        </div>
        <div class="row cl">
            <label class="form-label col-xs-4 col-sm-2">ID：</label>
            <div class="formControls col-xs-8 col-sm-9">
                <input type="text" class="input-text" value="${question1.id}" placeholder="" id="id" name="id">
            </div>
        </div>
        <div class="row cl">
            ...
            <div class="formControls col-xs-8 col-sm-9">
                <input type="text" class="input-text"
                       value="判断题：${question1.courses.courseName}/${question1.teacher_category.teacherCategoryName}"
        ...
        <div class="row cl">
            ...
            <div class="formControls col-xs-8 col-sm-9">
                <textarea name="question" cols="" rows="" class="textarea" placeholder="说点什么...最少输入10个字符"
                          datatype="*10-100" dragonfly="true"
                          nullmsg="备注不能为空！">${question1.smd_questions.question}</textarea>
        ...
        <div class="row cl">
            ...
            <div class="formControls col-xs-8 col-sm-9">
                <c:if test="${question1.smd_questions.answer==0}">
                    <label><input name="answer" type="radio" value="1"/>对 </label>
                    <label><input name="answer" type="radio" value="0" checked/>错 </label>
                </c:if>
                <c:if test="${question1.smd_questions.answer==1}">
                    <label><input name="answer" type="radio" value="1" checked/>对 </label>
                    <label><input name="answer" type="radio" value="0"/>错 </label>
                </c:if>
                <c:if test="${question1.smd_questions.answer!=1&&question1.smd_questions.answer!=0}">
                    <label><input name="answer" type="radio" value="1"/>对 </label>
                    <label><input name="answer" type="radio" value="0"/>错 </label>
                </c:if>
        ...
        <div class="row cl">
            ...
            <div class="formControls col-xs-8 col-sm-9">
                <textarea name="descrpt" id="descrpt" cols="" rows="" class="textarea" placeholder="说点什么...最少输入10个字符"
                          datatype="*10-100" dragonfly="true"
                          nullmsg="备注不能为空！">${question1.smd_questions.descrpt}</textarea>
                <p class="textarea-numberbar"><em class="textarea-length">0</em>/200</p>
            </div>
        </div>
