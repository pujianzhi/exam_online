...
<div class="loginWraper">
    <div id="loginform" class="loginBox">
        <div class="form form-horizontal" id="myform">
            <div class="row cl">
                <label class="form-label col-xs-3"><i class="Hui-iconfont">&#xe60d;</i></label>
                <div class="formControls col-xs-8">
                    <input id="eouNo" name="eouNo" type="text" placeholder="账户" class="input-text size-L">
                </div>
            </div>
            <div class="row cl">
                <label class="form-label col-xs-3"><i class="Hui-iconfont">&#xe60e;</i></label>
            ...
            <div class="row cl" id="checkCode" hidden>
                <div class="formControls col-xs-8 col-xs-offset-3">
                    ...
                    <img src="/user/checkCode"> <a id="kanbuq" href="index.jsp">看不清，换一张</a></div>
            </div>
            <div class="row cl">
                <div class="formControls col-xs-8 col-xs-offset-3">
...
<script>
    ...
    $(document).ready(function () {
        ...
        $("#submit").click(function () {
            // checkCode.show();
            if(checkCode.is(":hidden")){
                $.ajax({
                    type: "POST",
                    url: url,
                    data: {eouNo: userno.val(), passWord: password.val()},
                    success: function (accept) {
                        if (accept.isGo) {
                            window.location = accept.url;
                        } else {
                            checkCode.show();
                            alert(accept.msg);
                        }
                ...
                $.ajax({
                    type: "POST",
                    url: url,
                    data: {eouNo: userno.val(), passWord: password.val(),checkCode:$("#code").val()},
                    success: function (accept) {
                        if (accept.isGo) {
                            window.location = accept.url;
                        } else {
